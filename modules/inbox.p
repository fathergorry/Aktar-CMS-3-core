...
$msgs[^table::sql{
	SELECT m.*, u.name, u.lastname, u.rig  FROM ^dtp[privmsg] m 
...
^msgs.menu{
	...
	<div class="sender">^userbox[$msgs.author;$msgs.rig;$msgs.name $msgs.lastname;$.window[pmsend]] | ^ufdate[$msgs.msgdate] 
